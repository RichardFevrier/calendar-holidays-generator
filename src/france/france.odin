...
rec_events :: proc(year: int) -> [dynamic]calendar.Event {
	...
	date, err := datetime.components_to_date(year, 1, 1)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 2, 2)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 2, 14)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 3, 1)
	ord, err2 := datetime.date_to_ordinal(date)
	dow := datetime.day_of_week(ord)
	if dow != datetime.Weekday.Sunday {
		date, err = datetime.add_days_to_date(date, 7 - i64(dow))
	}
	append(
		&events,
		calendar.Event {
	...
	date, err = datetime.components_to_date(year, 5, 1)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 5, 8)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 6, 1)
	ord, err2 = datetime.date_to_ordinal(date)
	dow = datetime.day_of_week(ord)
	if dow != datetime.Weekday.Sunday {
		date, err = datetime.add_days_to_date(date, 7 - i64(dow))
	}
	date, err = datetime.add_days_to_date(date, 14)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 6, 21)
	append(&events, calendar.Event{date, "YEARLY", "Fête de la musique", "Fête de la musique."})

	date, err = datetime.components_to_date(year, 7, 14)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 8, 15)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 10, 1)
	ord, err2 = datetime.date_to_ordinal(date)
	dow = datetime.day_of_week(ord)
	if dow != datetime.Weekday.Sunday {
		date, err = datetime.add_days_to_date(date, 7 - i64(dow))
	...
	date, err = datetime.components_to_date(year, 10, 31)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 11, 1)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 11, 11)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.components_to_date(year, 12, 25)
	append(
		&events,
		calendar.Event {
			date,
...
dyn_events :: proc(year: int) -> [dynamic]calendar.Event {
	...
	if date.day == 1 {
		date, err = datetime.add_days_to_date(date, 7)
	}
	append(
		&events,
		calendar.Event {
	...
	date, err = datetime.components_to_date(year, 3, 1)
	date, err = datetime.add_days_to_date(date, i64(easter))
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.add_days_to_date(date, -48)
	append(
		&events,
		calendar.Event {
			date,
	...
	date, err = datetime.add_days_to_date(date, 48)
	date, err = datetime.add_days_to_date(date, 38)
	append(
		&events,
		calendar.Event {
			date,
	...
	pdate, err3 := datetime.add_days_to_date(date, 11)
	append(
		&events,
		calendar.Event {
			pdate,
	...
	date, err = datetime.components_to_date(year, 5, 31)
	ord, err2 = datetime.date_to_ordinal(date)
	dow = datetime.day_of_week(ord)
	if dow != datetime.Weekday.Sunday {
		date, err = datetime.add_days_to_date(date, -i64(dow))
	}
	pdate, err3 = datetime.add_days_to_date(pdate, -1)
